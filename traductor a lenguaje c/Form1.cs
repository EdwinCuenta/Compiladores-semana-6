...
namespace MeedCompy
{
    ...
    public partial class Form1 : Form
    {
        ...
        void pintar()
        {
            ...
            {
                string modelo = "";
                string[] palabras = { "si", "solo", "se", "repetir", "@", "#", "inicio", "hacer", "solo", "//", "MeedCompy" , "MeedMusic", "Meedot",
        ...
        void AnalalisisSintactico(string palabra, string tipo)
        {
            ...
            else
            {
                ...
                if (tipo == "apertura de llave") { llavesnecesarias = llavesnecesarias - 1; if (palabraanterior == "se" | palabraanterior == "inicio" | palabraanterior == "hacer") { analisisSin.Text = "sin errores entre amonos o hacer\n"; } else { richErroresSintac.Text = "verifica no tener palabras entre amonos o hacer y sus llaves\n"; } }
